...
We considered \textcolor{red}{nine} methods implemented in the `forecast` package in R [@forecast] for the pool of methods, $P$ in Algorithm \@ref(alg:algo-lab):
...
1. \textcolor{red}{neural network time series forecasts (`nnetar`).}
