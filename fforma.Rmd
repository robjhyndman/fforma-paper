...
We used a set of 42 features in for the model. The functions to calculate these features are implemented in `tsfeatures` R package by @tsfeatures. These features have been previously used by @fforms and @hyndman2015large. 
\autoref{features} provides a brief description of features used in this experiment. A detailed description of these features is provided in @fforms. 
