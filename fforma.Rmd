...
We considered nine forecasting algorithms implemented in the `forecast` R package. They are (the specific R calls for fitting the models are given):i) automated ARIMA algorithm (`auto.arima`), ii) automated ETS algorithm (`ets`),
