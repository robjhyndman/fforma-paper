...
(ii) the weights allocated by FFORMA can range from a simple averaging (equal weights), to a profile that assigns most of the importance to only a single method. This allows FFORMA to outperfom both simple averaging and method selection alternatives; (iii) FFORMA adapts to the methods in its pool, making the specific pool of methods less critical than in other combination approaches.}
