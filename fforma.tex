...
\todo{Pablo to add on the literature on ensemble methods}
...
weights for forecast combinations\todo{Pablo please review this}. We
...
\emph{difficult} than
others\todo{Not sure what difficult means here and how it is used - difficult to forecast? and then?}.
...
series.\todo{I think a lot of this - even all of it - can go if we need more space.}
